...
public class ReportController {
     ...
     * 根据月份获取会员数量
     */
    @RequestMapping(value = "/FindMenberByMonth",produces = "application/json;charset=utf-8")
    public Result FindByMonth(@RequestBody Map<String,String> timeRange){
        //{start=2019-02, end=2019-02}
        String start = timeRange.get("start");
        String end = timeRange.get("end");
        Map<String,Object> map = reportService.FindMenberByMonth(start, end);
